...
1. Clone the repository:
    ```sh
    git clone https://github.com/tupa11/laravel-live-score.git
    cd laravel-live-score
    ```
...
- Navigate to the home page to view the list of matches.
- Use the tabs to filter matches by their status.
